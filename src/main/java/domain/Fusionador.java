...
public class Fusionador {
    ...
    */
    ...
    /*public void compararComunidades(Comunidad comunidad, List<Comunidad> comunidades, List<Sugerencia> sugerencias){
        for (Comunidad otraComunidad : comunidades){
            if(cumpleCoincidenciasFusion(comunidad, otraComunidad)){
                //creamos sugerencia y eliminamos los dos elementos de la lista
                Sugerencia sugerencia = new Sugerencia(comunidad, otraComunidad, LocalDate.now());
                sugerencias.add(sugerencia);
                comunidades.remove(otraComunidad);
                break;
            }
        }
    }*/
